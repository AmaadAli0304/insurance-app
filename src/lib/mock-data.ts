...
export let mockStaffingRequests: StaffingRequest[] = [
  { id: 'req-001', patientId: 'pat-01', hospitalId: 'hosp-01', companyId: 'comp-01', packageId: 'stat-gold', requestAmount: 5200, status: 'Pending', createdAt: '2023-10-01T10:00:00Z', details: 'Patient John Doe admitted for cardiovascular observation. Required specialized nurse for 2 days.' },
  { id: 'req-002', patientId: 'pat-02', hospitalId: 'hosp-01', companyId: 'comp-01', packageId: 'stat-silver', requestAmount: 1250, status: 'Approved', createdAt: '2023-10-02T11:30:00Z', details: 'Patient Jane Smith required a physical therapist for a minor fracture rehab session.' },
  { id: 'req-003', patientId: 'pat-03', hospitalId: 'hosp-02', companyId: 'comp-02', packageId: 'flex-prem', requestAmount: 15000, status: 'Pending', createdAt: '2023-10-03T14:00:00Z', details: 'Emergency request for a surgical assistant for an appendectomy. Includes 3-day post-op monitoring.' },
  { id: 'req-004', patientId: 'pat-03', hospitalId: 'hosp-02', companyId: 'comp-02', packageId: 'flex-prem', requestAmount: 850, status: 'Rejected', createdAt: '2023-09-25T09:00:00Z', details: 'Request for follow-up consultation. Rejected as post-operative follow-ups are covered under the initial request.' },
];
