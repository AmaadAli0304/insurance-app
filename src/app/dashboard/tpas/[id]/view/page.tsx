    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold">TPA Details</h1>
                    <p className="text-muted-foreground">Viewing profile for {tpa.name}</p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Primary contact and location details for the TPA.</CardDescription>
                </CardHeader>
