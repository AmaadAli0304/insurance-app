...
import { handleUpdateStaff, getStaffById, getHospitalsForForm, getPresignedUrl } from "../../actions";
            ...
            try {
                ...
                if (fetchedStaff) {
                    ...
                    if (fetchedStaff.photo) {
                         try {
                            const photoData = JSON.parse(fetchedStaff.photo as string);
                            setPhotoUrl(photoData.url);
                            setPhotoName(photoData.name);
                        } catch {
                            if (typeof fetchedStaff.photo === 'string' && fetchedStaff.photo.startsWith('http')) {
                                setPhotoUrl(fetchedStaff.photo);
                                setPhotoName('Uploaded Photo');
                            }
                        }
                    }
                ...
                setHospitals(hospitalList.filter(h => h.id));
         ...
         return (
            <Card>
                ...
                <CardContent>
                    ...
                    <Button asChild className="mt-4"><Link href="/dashboard/staff">Go Back</Link></Button>
                </CardContent>
            </Card>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-lg font-semibold md:text-2xl">Edit Staff Member: {staff.name}</h1>
            </div>
                 ...
                 <div className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the basic details for the staff member.</CardDescription>
                        </CardHeader>
