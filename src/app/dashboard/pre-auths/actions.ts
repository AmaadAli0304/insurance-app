...
async function savePreAuthRequest(formData: FormData, status: PreAuthStatus, shouldSendEmail: boolean) {
  ...
  try {
    ...
    const preAuthRequestResult = await preAuthInsertRequest
        ...
        .input('staff_id', sql.NVarChar, data.staff_id)
