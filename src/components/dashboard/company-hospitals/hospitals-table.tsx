          ...
          <TableRow key={h.id} onClick={() => handleRowClick(h.id)} className="cursor-pointer">
            ...
            <TableCell onClick={(e) => e.stopPropagation()}>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Are you sure you want to archive this hospital?</AlertDialogTitle>
                    <AlertDialogDescription>
                      This action will mark the hospital as archived and hide it from most views.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
